...
// CreateGame provides a mock function with given fields: ctx, answer, guessLimit
func (_m *MockService) CreateGame(ctx context.Context, answer string, guessLimit int) (*wording.Game, error) {
	ret := _m.Called(ctx, answer, guessLimit)

	var r0 *wording.Game
	if rf, ok := ret.Get(0).(func(context.Context, string, int) *wording.Game); ok {
		r0 = rf(ctx, answer, guessLimit)
	} else {
		if ret.Get(0) != nil {
...
//  - answer string
//  - guessLimit int
func (_e *MockService_Expecter) CreateGame(ctx interface{}, answer interface{}, guessLimit interface{}) *MockService_CreateGame_Call {
	return &MockService_CreateGame_Call{Call: _e.mock.On("CreateGame", ctx, answer, guessLimit)}
}

func (_c *MockService_CreateGame_Call) Run(run func(ctx context.Context, answer string, guessLimit int)) *MockService_CreateGame_Call {
...
func (_m *MockService) DeleteGame(ctx context.Context, adminToken string) error {
...
// MockService_DeleteGame_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteGame'
type MockService_DeleteGame_Call struct {
	*mock.Call
}
...
//  - ctx context.Context
//  - adminToken string
func (_e *MockService_Expecter) DeleteGame(ctx interface{}, adminToken interface{}) *MockService_DeleteGame_Call {
	return &MockService_DeleteGame_Call{Call: _e.mock.On("DeleteGame", ctx, adminToken)}
}

func (_c *MockService_DeleteGame_Call) Run(run func(ctx context.Context, adminToken string)) *MockService_DeleteGame_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockService_DeleteGame_Call) Return(_a0 error) *MockService_DeleteGame_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *MockService) GameStats(ctx context.Context, adminToken string) (wording.Stats, error) {
	ret := _m.Called(ctx, adminToken)
...
// MockService_GameStats_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GameStats'
type MockService_GameStats_Call struct {
	*mock.Call
}
...
//  - ctx context.Context
//  - adminToken string
func (_e *MockService_Expecter) GameStats(ctx interface{}, adminToken interface{}) *MockService_GameStats_Call {
	return &MockService_GameStats_Call{Call: _e.mock.On("GameStats", ctx, adminToken)}
}

func (_c *MockService_GameStats_Call) Run(run func(ctx context.Context, adminToken string)) *MockService_GameStats_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockService_GameStats_Call) Return(_a0 wording.Stats, _a1 error) *MockService_GameStats_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
